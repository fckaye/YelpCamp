...
const seedDB = async () => {
  ...
  for (let i = 0; i < 300; i++) {
    ...
    const camp = new Campground({
      ...
      description:
        "Lorem, ipsum dolor sit amet consectetur adipisicing elit. Sint illum dolores rerum suscipit voluptatem? Laudantium earum, aperiam quis aut dolorum perferendis, aliquam reprehenderit, incidunt voluptate accusamus et dolore temporibus nihil.",
      price: price,
